...
if __name__ == '__main__':
    ...
    processed_file_metadata = (
        "/data/ongh0068/pyg_output_playground/train/processed_file_paths.csv"
    )
    ...
    train_dataset = MolerDataset(
        root="/data/ongh0068",
        raw_moler_trace_dataset_parent_folder="/data/ongh0068/trace_playground",
        output_pyg_trace_dataset_parent_folder="/data/ongh0068/pyg_output_playground",
        split="train",
    )
